...
useEffect(() => {
  ...
  return (
    ...
    <div className="min-h-screen flex items-center justify-center px-6 bg-gradient-to-br from-green-700 via-green-800 to-green-950 relative overflow-hidden">
      ...
      {/* CARD */}
      <div
        className={`relative bg-white/95 backdrop-blur rounded-3xl shadow-2xl w-full max-w-6xl p-10 grid md:grid-cols-2 gap-12
      ...
      >
        ...
        {/* RIGHT */}
        <div className="bg-slate-50 rounded-2xl p-8 shadow-inner flex flex-col justify-center space-y-5">
